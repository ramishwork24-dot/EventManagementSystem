...
class BookingItem(models.Model):
    ...
    ticket_type = models.ForeignKey(Ticket, on_delete=models.CASCADE, related_name="booking_items")
    ...
    def __str__(self):
        return f"{self.quantity}x {self.ticket_type.tier_name} (Booking #{self.booking_id})"
